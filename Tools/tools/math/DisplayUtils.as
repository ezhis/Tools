package tools.math 
{
	...
	{	
		...
		public static function fitIntoRect(displayObjectSize : Rectangle, rectangle : Rectangle, fillRect : Boolean = true, align : String = "C", applyTransform : Boolean = true) :Number
		{
			//var displayObject:Rectangle = displayObjectSize;
			//var matrix : Matrix = new Matrix();
			
			var wD : Number = displayObjectSize.width /// displayObject.scaleX;
			var hD : Number = displayObjectSize.height /// displayObject.scaleY;
